import { _ as __vitePreload } from "../chunks/preload-helper.s47w4USC.js";
import { s as safe_not_equal, c as create_slot, u as update_slot_base, g as get_all_dirty_from_scope, d as get_slot_changes } from "../chunks/scheduler.9_m0mCEV.js";
import { S as SvelteComponent, i as init, d as transition_in, t as transition_out } from "../chunks/index.Iyl_OSSJ.js";
const PUBLIC_SUPABASE_URL = "https://hspfduumtusknleyjeoi.supabase.co";
const PUBLIC_SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhzcGZkdXVtdHVza25sZXlqZW9pIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDM4NDkzOTYsImV4cCI6MjAxOTQyNTM5Nn0._zzgDhByfX7TnvQNC3pzF-zgsg1zCNvVCbV5Vo29xZw";
...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(() => import("../chunks/browser.LIgXhNEn.js").then((n) => n.b), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then(({ default: WS }) => {
      ...
      storage: {
        getItem: async (key) => {
          const chunkedCookie = await combineChunks(key, async (chunkName) => {
            ...
            if (isBrowser()) {
              const cookie = parse_1(document.cookie);
          ...
          await Promise.all(
            chunks.map(async (chunk) => {
              if (typeof cookies.set === "function") {
                ...
                if (isBrowser()) {
                  document.cookie = serialize_1(chunk.name, chunk.value, {
                    ...DEFAULT_COOKIE_OPTIONS,
                    ...cookieOptions,
                    maxAge: DEFAULT_COOKIE_OPTIONS.maxAge
                  });
        ...
        removeItem: async (key) => {
          ...
          await deleteChunks(
            ...
            async (chunkName) => {
              ...
              if (isBrowser()) {
                const documentCookies = parse_1(document.cookie);
            ...
            async (chunkName) => {
              if (typeof cookies.remove === "function") {
                ...
                if (isBrowser()) {
                  document.cookie = serialize_1(chunkName, "", {
                    ...DEFAULT_COOKIE_OPTIONS,
                    ...cookieOptions,
                    maxAge: 0
                  });
...
const load = async ({ fetch: fetch2, data, depends }) => {
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["../chunks/browser.LIgXhNEn.js","../chunks/_commonjsHelpers.jUUCeJQL.js"]
  }
