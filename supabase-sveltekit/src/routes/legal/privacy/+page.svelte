...
On sign-up: Email address<br />
If you contact me by email: Name connected with the email account - as part of the message.<br />
If you wish me to delete your message after reading it, please indicate it in the message.

<h3 id="non-personally-identifiable-information">Non-personally Identifiable Information</h3>
While using the extension information about your saves:<br /> Page URL &amp; title<br />
Timestamp<br />
Highlighted text<br />
Get automatically uploaded to the server.
<h2 id="security">Security</h2>
It is your responsibility not to save sensitive information e.g. your passwords as a part of a highlight.<br />When
you delete your save all information about it gets deleted from the server - a copy remains only on your
computer to provide undo functionality.
