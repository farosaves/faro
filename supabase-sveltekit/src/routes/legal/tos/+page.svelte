...
<p>
  ...
  website and notify you should anything material change. By continuing to use the Services after the changes
  become effective, you agree to the revised Terms.
</p>
<h2 id="eligibility">Eligibility</h2>
<p>
  By agreeing to these Terms, you represent and warrant to us that you are at least thirteen (13) years of age
  and that your use of the Service is in compliance with any and all applicable laws and regulations.
</p>
<h2 id="prohibited-uses">Prohibited Uses</h2>
<p>
  By accepting these terms you agree not to use the Software for conducting any activities illegal in your
  jurisdiction.
</p>
<p>You agree not to copy, modify or attempt to reverse-engineer the Software.</p>
<p>
  If you share your account with anyone it is your sole responsibility to ensure the persons you share it with
...
<p>
  We grant you a worldwide, non-exclusive and non-transferable right to use the service in accordance with
  these terms.
</p>
...
<p>
  ...
  available” basis. We hereby disclaim all warranties of any kind, explicit or implied, including, without
