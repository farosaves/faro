...
<div class="flex items-center justify-center h-full p-4 bg-neutral text-neutral-content">
  <div class="w-full max-w-xl p-10 card bg-base-300">
    <form
      ...
      <a class="w-full btn btn-secondary" href="/account/sign-out"> Sign Out </a>
    </form>
  </div>
</div>
