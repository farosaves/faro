...
<div class="hero min-h-screen bg-base-200">
  {#if form?.success}<div class="flex justify-center btn btn-lg btn-primary z-10 text-5xl font-bold">
  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center lg:text-left">
      ...
      <p class="py-6">It will be converted to a webpage so that highlighting will work.</p>
    </div>
